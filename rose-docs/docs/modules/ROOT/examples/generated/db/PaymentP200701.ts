...
export const PaymentP200701DefaultQueries = {
	insertOne: function insertOne(row: PaymentP200701InsertRow) {
		return rose.insertFromObject<TPaymentP200701, PaymentP200701InsertRow>(QPaymentP200701, row).finalise({});
	},
};
