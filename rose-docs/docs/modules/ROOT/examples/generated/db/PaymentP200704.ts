...
export const PaymentP200704DefaultQueries = {
	insertOne: function insertOne(row: PaymentP200704InsertRow) {
		return rose.insertFromObject<TPaymentP200704, PaymentP200704InsertRow>(QPaymentP200704, row).finalise({});
	},
};
