...
export function between(value: ParameterOrValueExpressionNode, start: ParameterOrValueExpressionNode, end: ParameterOrValueExpressionNode) {
...
export function betweenSymmetric(value: ParameterOrValueExpressionNode, start: ParameterOrValueExpressionNode, end: ParameterOrValueExpressionNode) {
	return createNaturalSyntaxFunctionNode(
		undefined,
		[
			{
...
export function isDistinctFrom(value: ParameterOrValueExpressionNode, other: ParameterOrValueExpressionNode) {
...
export function isNotDistinctFrom(value: ParameterOrValueExpressionNode, other: ParameterOrValueExpressionNode) {
...
export function notBetween(value: ParameterOrValueExpressionNode, start: ParameterOrValueExpressionNode, end: ParameterOrValueExpressionNode) {
	return createNaturalSyntaxFunctionNode(
		undefined,
		[
			{
