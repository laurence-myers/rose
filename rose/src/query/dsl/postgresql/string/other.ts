...
export function ascii(
	string: ParameterOrValueExpressionNode
): FunctionExpressionNode {
 ...
 */
export function btrim(
	string: ParameterOrValueExpressionNode,
	characters?: ParameterOrValueExpressionNode
): FunctionExpressionNode {
...
export function convert(
	string: ParameterOrValueExpressionNode,
	src_encoding: ParameterOrValueExpressionNode,
	dest_encoding: ParameterOrValueExpressionNode
): FunctionExpressionNode {
...
export function decode(
	string: ParameterOrValueExpressionNode,
	format: ParameterOrValueExpressionNode
): FunctionExpressionNode {
...
export function encode(
	data: ParameterOrValueExpressionNode,
	format: ParameterOrValueExpressionNode
): FunctionExpressionNode {
...
export function length(
	string: ParameterOrValueExpressionNode,
	encoding?: ParameterOrValueExpressionNode
): FunctionExpressionNode {
...
export function lpad(
	string: ParameterOrValueExpressionNode,
	length: ParameterOrValueExpressionNode,
	fill?: ParameterOrValueExpressionNode
): FunctionExpressionNode {
	if (fill !== undefined) {
 ...
 */
export function quote_literal(
	stringOrValue: ParameterOrValueExpressionNode
): FunctionExpressionNode {
 ...
 */
export function quote_nullable(
	stringOrValue: ParameterOrValueExpressionNode
): FunctionExpressionNode {
 ...
 */
export function regexp_match(
	string: ParameterOrValueExpressionNode,
	pattern: ParameterOrValueExpressionNode,
	flags?: ParameterOrValueExpressionNode
): FunctionExpressionNode {
	if (flags !== undefined) {
...
export function regexp_replace(
	string: ParameterOrValueExpressionNode,
	pattern: ParameterOrValueExpressionNode,
	replacement: ParameterOrValueExpressionNode,
	flags?: ParameterOrValueExpressionNode
): FunctionExpressionNode {
	if (flags !== undefined) {
 ...
 */
export function regexp_split_to_array(
	string: ParameterOrValueExpressionNode,
	pattern: ParameterOrValueExpressionNode,
	flags?: ParameterOrValueExpressionNode
): FunctionExpressionNode {
 ...
 * Split string using a POSIX regular expression as the delimiter. See Section 9.7.3 for more information.
 */
export function regexp_split_to_table(
	string: ParameterOrValueExpressionNode,
	pattern: ParameterOrValueExpressionNode,
	flags?: ParameterOrValueExpressionNode
): FunctionExpressionNode {
...
export function repeat(
	string: ParameterOrValueExpressionNode,
	number: ParameterOrValueExpressionNode
): FunctionExpressionNode {
...
export function replace(
	string: ParameterOrValueExpressionNode,
	from: ParameterOrValueExpressionNode,
	to: ParameterOrValueExpressionNode
): FunctionExpressionNode {
 ...
 */
export function split_part(
	string: ParameterOrValueExpressionNode,
	delimiter: ParameterOrValueExpressionNode,
	field: ParameterOrValueExpressionNode
): FunctionExpressionNode {
...
export function strpos(
	string: ParameterOrValueExpressionNode,
	substring: ParameterOrValueExpressionNode
): FunctionExpressionNode {
