...
export function json_object_agg(
	name: ParameterOrValueExpressionNode,
 ...
 * aggregates name/value pairs as a JSON object; values can be null, but not names
 */
export function jsonb_object_agg(
	name: ParameterOrValueExpressionNode,
	value: ParameterOrValueExpressionNode
): FunctionExpressionNode {
