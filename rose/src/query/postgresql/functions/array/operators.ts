import { createBinaryOperatorNode, createBooleanBinaryOperatorNode } from "../common";
 ...
 */
export function arrayContains(left: ParameterOrValueExpressionNode, right: ParameterOrValueExpressionNode) {
 ...
 */
export function arrayIsContainedBy(left: ParameterOrValueExpressionNode, right: ParameterOrValueExpressionNode) {
	return createBooleanBinaryOperatorNode('<@', left, right);
}
 ...
 */
export function arraysOverlap(left: ParameterOrValueExpressionNode, right: ParameterOrValueExpressionNode) {
	return createBooleanBinaryOperatorNode('&&', left, right);
}
 ...
 */
export function concatenateArray(left: ParameterOrValueExpressionNode, right: ParameterOrValueExpressionNode) {
