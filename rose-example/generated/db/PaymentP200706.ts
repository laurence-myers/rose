...
export const PaymentP200706DefaultQueries = {
	insertOne: function insertOne(row: PaymentP200706InsertRow) {
		return rose.insertFromObject<TPaymentP200706, PaymentP200706InsertRow>(QPaymentP200706, row).finalise({});
	},
};
