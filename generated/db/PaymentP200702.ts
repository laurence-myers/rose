...
export const PaymentP200702DefaultQueries = {
	insertOne: function updateOne(row: PaymentP200702InsertRow) {
		return rose.insertFromObject<TPaymentP200702, PaymentP200702InsertRow, {}>(QPaymentP200702, row).prepare();
	},
};
